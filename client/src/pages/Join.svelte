...
<div class="container">
    <div class="join">
        <h1 in:fly={getIn(0)} out:fly={getOut(0)}>Join a Game</h1>
        <div class="form">
        ...
        <button on:click|preventDefault={handleJoinGame} in:fly={getIn(7)} out:fly={getOut(7)}>Join Game</button>
        <div class="wrapper">
            <Link class="join-game-link" to={"/game"}></Link>
        </div>
    </div>
